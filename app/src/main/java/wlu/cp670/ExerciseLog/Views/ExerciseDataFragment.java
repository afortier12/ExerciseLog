 ...
 *
 * layout: fragment_exercise_detail.xml
 *
 * @author fort7350
 * @version 1.0
 */
...
public class ExerciseDataFragment extends Fragment implements View.OnClickListener {
    ...
    /**
     * map of common weights for weight dialog
     */
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null)
            if (savedInstanceState.getParcelable(DETAIL_ITEM_ARG) != null) {
                exercise = savedInstanceState.getParcelable(DETAIL_ITEM_ARG);
            }
    ...
    /**
     * Prompt for loading of last exercise data if exists
     *
     * @param view
     * @param savedInstanceState
     */
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelable(DETAIL_ITEM_ARG, exercise);
     ...
     * Called from onClick
     *
     * Displays custom dialog for selecting weights
     * layout: weight_dialog.xml
     *
     * @param view
     */
    ...
    /**
     * Called from WeightButtonDialogClick class
     *
     * Calculates total weight selected in the weightDialog
     *
     * @param rDialog
     */
    ...
    /**
     * Greys out the button if setFlag is false
     *
     * @see "https://stackoverflow.com/questions/8743120/how-to-grey-out-a-button"
     * @param button
     * @param setFlag
     */
    ...
    /**
     *
     * @return true if weight within range and a multiple of weightMultiple
     */
    private boolean checkWeightField(){
        ...
        return (weightValue.compareTo(maxWeight) <= 0) && (weightValue.compareTo((minWeight)) >= 0)
    ...
    private boolean checkRepsField(){
        ...
        return (repsValue.compareTo(maxReps) <= 0) && (repsValue.compareTo(minReps) >= 0)
 ...
 *
 * Implements View.OnClickListener for weightDialog object
 *
 *
 * @author fort7350
 * @version 1.0
    ...
    */
    class ValueChangeWatcher implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            backspaceFlag = before == 1 && count == 0;
        }
        ...
        * Class NumberFilter
        *
        * Implements InputFilter for EditText widgets
        *
        *
        * @author fort7350
        * @version 1.0
